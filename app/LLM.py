...
def build_simple_template():
    prompt_template = "你是托辊智能助手小辊，你服务于托辊安全卫士项目。请你使用自己的知识回答用户问题。回答要清晰准确，包含正确关键词。如果所给材料与用户问题无关，请回答：无答案\n" \
                        "用户问题：\n" \
                        "{}\n"
...
def build_repair_template():
    ...
    prompt_template = "你是托辊智能助手小辊，你服务于托辊安全卫士项目。请你基于以下巡检机器人手册调整优化用户问题的答案，要求答案尽可能的清晰准确，并且包含正确的关键词。如果没有必要调整则将原答案重复即可。\n" \
                      "以下是材料：\n---" \
                      "{}\n" \
                      "用户问题：\n" \
                        "{}\n" \
